                ...
                <div className={`rounded-full p-6 ${style.primaryColor}`}>
                    <div className={`flex h-16 w-16 items-center justify-center rounded-full p-4 ${style.secondaryColor}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="h-8 w-8 text-white">
                            {
                                type === AlertCardType.Error && (<path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />)
                            }
                            {
                                type === AlertCardType.Success && (<path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />)
                            }
                        </svg>
                    </div>
                </div>
